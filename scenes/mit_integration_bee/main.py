"""Ponto de entrada do vídeo MIT Integration Bee.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Renderiza o vídeo MIT Integration Bee")
    parser.add_argument(
        "--preview", "-p",
        action="store_true",
    ...
    from scenes import MITIntegrationBee

    cena = MITIntegrationBee()
