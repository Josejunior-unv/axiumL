"""Configuração do Manim para o vídeo vertical 1080x1920 @ 240 FPS.
...
def aplicar_configuracao(preview: bool = False) -> None:
    ...
    # Organização da saída: media/videos/mit_integration_bee/<qualidade>/
    config.media_dir = str(PASTA_MEDIA)
    config.video_dir = "{media_dir}/videos/mit_integration_bee/{quality}"
    config.output_file = "MITIntegrationBee"
