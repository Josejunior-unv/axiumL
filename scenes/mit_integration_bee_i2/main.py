"""Ponto de entrada do vídeo MIT Integration Bee — I2.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Renderiza o vídeo MIT Integration Bee I2")
    parser.add_argument(
        "--preview", "-p",
        action="store_true",
    ...
    from scenes import MITIntegrationBeeI2

    cena = MITIntegrationBeeI2()
