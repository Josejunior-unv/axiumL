"""Ponto de entrada do vÃ­deo a Fórmula de Euler.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Renderiza o vÃ­deo a Fórmula de Euler")
    parser.add_argument(
        "--preview", "-p",
        action="store_true",
    ...
    from scenes import FormulaEuler
