"""Ponto de entrada do vÃ­deo o Problema da Basileia.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Renderiza o vÃ­deo o Problema da Basileia")
    parser.add_argument(
        "--preview", "-p",
        action="store_true",
    ...
    from scenes import ProblemaBasileia

    cena = ProblemaBasileia()
