"""Configuração do Manim para o vídeo vertical 1080x1920 @ 240 FPS (0,999... = 1).
...
def aplicar_configuracao(preview: bool = False) -> None:
    ...
    # Organização da saída: media/videos/dizima_0999/<qualidade>/
    config.media_dir = str(PASTA_MEDIA)
    config.video_dir = "{media_dir}/videos/dizima_0999/{quality}"
    config.output_file = "Dizima0999"
