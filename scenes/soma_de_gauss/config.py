"""Configuração do Manim para o vídeo vertical 1080x1920 @ 240 FPS (Soma de Gauss).
...
def aplicar_configuracao(preview: bool = False) -> None:
    ...
    # Organização da saída: media/videos/soma_de_gauss/<qualidade>/
    config.media_dir = str(PASTA_MEDIA)
    config.video_dir = "{media_dir}/videos/soma_de_gauss/{quality}"
    config.output_file = "SomaDeGauss"
