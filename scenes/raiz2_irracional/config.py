"""Configuração do Manim para o vídeo vertical 1080x1920 @ 240 FPS (√2 irracional).
...
# Mesmo padrão dos vídeos MIT Integration Bee: 1080x1920 (9:16) a 240 FPS
LARGURA_FINAL = 1080
ALTURA_FINAL = 1920
FPS_FINAL = 240
...
def aplicar_configuracao(preview: bool = False) -> None:
    ...
    # Organização da saída: media/videos/raiz2_irracional/<qualidade>/
    config.media_dir = str(PASTA_MEDIA)
    config.video_dir = "{media_dir}/videos/raiz2_irracional/{quality}"
    config.output_file = "Raiz2Irracional"
