"""Ponto de entrada do vídeo √2 é Irracional.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Renderiza o vídeo √2 é Irracional")
    parser.add_argument(
        "--preview", "-p",
        action="store_true",
    ...
    from scenes import Raiz2Irracional

    cena = Raiz2Irracional()
