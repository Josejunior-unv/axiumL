...
def aplicar_configuracao(preview: bool = False) -> None:
    ...
    # OrganizaÃ§Ã£o da saÃ­da: media/videos/integral_gaussiana/<qualidade>/
    config.media_dir = str(PASTA_MEDIA)
    config.video_dir = "{media_dir}/videos/integral_gaussiana/{quality}"
    config.output_file = "IntegralGaussiana"
